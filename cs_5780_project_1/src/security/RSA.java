...
public class RSA
{
  ...
  public static class Key
  {
    ...
    public void read(byte[] paramArrayOfByte)
      throws IOException
    {
  ...
  {
    public PublicKey(InputStream paramInputStream)
      throws IOException
    {
    ...
    public PublicKey(byte[] paramArrayOfByte)
      throws IOException
    {
  ...
  {
    public PrivateKey(InputStream paramInputStream)
      throws IOException
    {
      read(paramInputStream);
    }
    ...
    public PrivateKey(byte[] paramArrayOfByte)
      throws IOException
    {
      read(paramArrayOfByte);
    }
